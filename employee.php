        ...
        <div class="container p-3 my-3 border border-warning rounded bg">          
            ...
            <form class="form-inline row">
                <div class="form-group col-sm-4">
                    <input type="text" class="form-control" id="employeeName" placeholder="搜尋員工名稱" name="employeeName">
                    <input type ="button" class="btn btn-primary" value="搜尋" onclick="location.href='employee_inform.php'"></input>
                </div>
                <div class="form-group col-sm-4" >
                    <input type="text" class="form-control" id="employeeName" placeholder="輸入員工名稱" name="employeeName">
                    <input type ="button" class="btn btn-primary" value="刪除" onclick="location.href='employee_delete.php'"></input>
                </div>
